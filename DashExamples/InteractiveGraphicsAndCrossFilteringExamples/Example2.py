...
# print(df.columns)
# cond1 = df["Indicator Name"]=='Fertility rate, total (births per woman)'
# cond2 = df["Country Name"] == "Japan"
# cond3 = df["Year"] == df['Year'].max()
...
app.layout = html.Div([html.Div([html.Div([dcc.Dropdown(id='crossfilter-xaxis-column',
                       ...
                       html.Div(dcc.Slider(id='crossfilter-year--slider',
                                           min=df['Year'].min(),
                                           max=df['Year'].max(),
                                           value=df['Year'].max(),
